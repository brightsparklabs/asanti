 ...
 */
public class OLDAsnSchemaTypeDefinitionSetOf extends OLDAsnSchemaTypeDefinitionCollectionOf
{
    // -------------------------------------------------------------------------
    // CONSTRUCTION
    // -------------------------------------------------------------------------
     ...
     */
    public OLDAsnSchemaTypeDefinitionSetOf(String name, String elementTypeName,

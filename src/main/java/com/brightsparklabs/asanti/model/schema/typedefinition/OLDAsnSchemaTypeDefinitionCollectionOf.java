 ...
 */
public abstract class OLDAsnSchemaTypeDefinitionCollectionOf
        extends AbstractOLDAsnSchemaTypeDefinition
{
     ...
     *             {@link #validTypes}
     */
    public OLDAsnSchemaTypeDefinitionCollectionOf(String name, AsnBuiltinType builtinType,
            String elementTypeName, AsnSchemaConstraint constraint)
    {

 ...
 * ENUMERATED (see {@link OLDAsnSchemaTypeDefinitionConstructed}).
 *
 * @author brightSPARK Labs
 */
public abstract class OLDAsnSchemaTypeDefinitionPrimitive extends AbstractOLDAsnSchemaTypeDefinition
{
    // -------------------------------------------------------------------------
    // CLASS VARIABLES
    // -------------------------------------------------------------------------
     ...
     */
    public OLDAsnSchemaTypeDefinitionPrimitive(String name, AsnBuiltinType builtinType,

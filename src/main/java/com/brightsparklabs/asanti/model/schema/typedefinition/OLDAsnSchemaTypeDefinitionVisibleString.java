 ...
 */
public class OLDAsnSchemaTypeDefinitionVisibleString extends OLDAsnSchemaTypeDefinitionPrimitive
{
    // -------------------------------------------------------------------------
    // CONSTRUCTION
    // -------------------------------------------------------------------------
     ...
     */
    public OLDAsnSchemaTypeDefinitionVisibleString(String name, AsnSchemaConstraint constraint)
    {

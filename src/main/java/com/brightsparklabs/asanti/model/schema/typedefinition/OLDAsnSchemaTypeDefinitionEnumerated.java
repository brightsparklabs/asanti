 ...
 */
public class OLDAsnSchemaTypeDefinitionEnumerated extends AbstractOLDAsnSchemaTypeDefinition
{
    // -------------------------------------------------------------------------
    // CLASS VARIABLES
    // -------------------------------------------------------------------------
    ...
    /** class logger */
    private static final Logger logger = LoggerFactory.getLogger(OLDAsnSchemaTypeDefinitionEnumerated.class);
     ...
     */
    public OLDAsnSchemaTypeDefinitionEnumerated(String name, Iterable<AsnSchemaNamedTag> options)
    {

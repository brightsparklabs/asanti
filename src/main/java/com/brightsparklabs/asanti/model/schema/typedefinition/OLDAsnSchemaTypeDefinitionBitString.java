 ...
 */
public class OLDAsnSchemaTypeDefinitionBitString extends OLDAsnSchemaTypeDefinitionPrimitive
{
    // -------------------------------------------------------------------------
    // CONSTRUCTION
    // -------------------------------------------------------------------------
     ...
     */
    public OLDAsnSchemaTypeDefinitionBitString(String name, AsnSchemaConstraint constraint)
    {

...
/**
 * A {@code BitString} component/tag type from a within a module specification
 * within an ASN.1 schema.
 *
 * @author brightSPARK Labs
 */
public class AsnSchemaTagTypeBitString extends AbstractAsnSchemaTagType
{
    // -------------------------------------------------------------------------
    // CONSTRUCTION
    // -------------------------------------------------------------------------
     ...
     *
     */
    public AsnSchemaTagTypeBitString(AsnSchemaConstraint constraint)
    {
        super(AsnBuiltinType.BitString, constraint);
    }

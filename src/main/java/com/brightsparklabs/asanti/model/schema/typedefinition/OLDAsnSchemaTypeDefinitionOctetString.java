 ...
 */
public class OLDAsnSchemaTypeDefinitionOctetString extends OLDAsnSchemaTypeDefinitionPrimitive
{
    // -------------------------------------------------------------------------
    // CONSTRUCTION
    // -------------------------------------------------------------------------
     ...
     */
    public OLDAsnSchemaTypeDefinitionOctetString(String name, AsnSchemaConstraint constraint)
    {

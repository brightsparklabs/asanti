...
/**
 * Convenience class to simplify implementing {@link OLDAsnSchemaTypeDefinition}
 *
 * @author brightSPARK Labs
 */
public abstract class AbstractOLDAsnSchemaTypeDefinition implements OLDAsnSchemaTypeDefinition
{
    // -------------------------------------------------------------------------
    // INSTANCE VARIABLES
    // -------------------------------------------------------------------------
     ...
     */
    public AbstractOLDAsnSchemaTypeDefinition(String name, AsnBuiltinType builtinType,

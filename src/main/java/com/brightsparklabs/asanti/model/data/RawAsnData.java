...
public interface RawAsnData {
     ...
     * tags for an Integer type is [UNIVERSAL 2].
     *
     * <p>E.g. "/1[1]/1[UNIVERSAL 16]/1[4]", "3[0]/1[4]/2[1]", "/2[UNIVERSAL 17]/4[UNIVERSAL
     * 16]/0[UNIVERSAL 2]"
     *
     ...
     *
     * @param rawTag tag associated with the data
     ...
     *
     * <p>E.g. "/0[1]/0[1]/0[1]" =&gt; "[0x00, 0x01]", "0[3]/1[1]/0[2]" =&gt; "[0x00, 0x01]"
     *
     ...
     *
     * <p>E.g. <code>
     * getBytesMatching(Pattern.compile("/0[1]/2[1]/.*")) =&gt; { "/0[1]/2[1]/0[1]" =&gt;

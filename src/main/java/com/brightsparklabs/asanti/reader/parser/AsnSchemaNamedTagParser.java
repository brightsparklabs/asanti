...
public class AsnSchemaNamedTagParser {
    ...
    public static ImmutableList<AsnSchemaNamedTag> parseEnumeratedOptions(
            final String enumeratedOptionsText) throws ParseException {
    ...
    public static ImmutableList<AsnSchemaNamedTag> parseIntegerDistinguishedValues(
            final String distinguishedValuesText) throws ParseException {
        final ImmutableList.Builder<AsnSchemaNamedTag> builder = ImmutableList.builder();
    ...
    private static AsnSchemaNamedTag parseOption(
            final String optionLine, final Set<Integer> usedTags) throws ParseException {
     ...
     */
    private static String generateUniqueTagNumber(final Set<Integer> usedTags, final String tagName)
            throws ParseException {
    ...
    private static void ensureTagUnique(
            final String tag, final Set<Integer> usedTags, final String tagName)
            throws ParseException {

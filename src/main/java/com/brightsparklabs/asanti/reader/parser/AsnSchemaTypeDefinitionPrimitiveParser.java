...
public final class AsnSchemaTypeDefinitionPrimitiveParser
{
     ...
     */
    public static AsnSchemaTypeDefinitionIa5String parseIA5String(String name,
     ...
     *         if any errors occur while parsing the type
     */
    public static AsnSchemaTypeDefinitionUtf8String parseUTF8String(String name,
            String constraintText)
            throws ParseException
    {
        final AsnSchemaConstraint constraint = AsnSchemaConstraintParser.parse(constraintText);
     ...
     *         if any errors occur while parsing the type
     */
    public static AsnSchemaTypeDefinitionGeneralString parseGeneralString(String name,
    ...
    public static AsnSchemaTypeDefinitionInteger parseInteger(String name,
            Iterable<AsnSchemaNamedTag> distinguishedValues, String constraintText)
            throws ParseException
    {
        final AsnSchemaConstraint constraint = AsnSchemaConstraintParser.parse(constraintText);

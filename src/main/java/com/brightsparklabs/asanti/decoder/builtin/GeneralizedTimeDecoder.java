...
public class GeneralizedTimeDecoder extends AbstractBuiltinTypeDecoder<OffsetDateTime>
{
    ...
    private static final DateTimeFormatter core = new DateTimeFormatterBuilder()
            .appendYear(4, 4)
            .appendMonthOfYear(2)
            .appendDayOfMonth(2)
            .appendHourOfDay(2)
    ...
    private static final DateTimeParser comma = new DateTimeFormatterBuilder()
            .appendLiteral(",")
            .toParser();

    /** a dot as a separator - decimal place */
    private static final DateTimeParser dot = new DateTimeFormatterBuilder()
            .appendLiteral(".")
            .toParser();
    ...
    private static final DateTimeFormatter uptoHours = new DateTimeFormatterBuilder()
            .append(core)
     ...
     * offset
     */
    private static final DateTimeFormatter uptoSeconds = new DateTimeFormatterBuilder()
            .append(core)
            .appendMinuteOfHour(2)
     ...
     * only match if this is specifying seconds (hence the 14 digits) because otherwise the decimal
     * is for fractions of minutes or hours.
     */

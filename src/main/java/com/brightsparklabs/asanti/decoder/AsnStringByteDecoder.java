 ...
 * {@link AsnByteDecoder} from containing too much logic. The methods in here are designed to be
 * called by {@link AsnByteDecoder} (hence why they use package visibility). Do not call the methods
 * in this class directly. Use {@link AsnByteDecoder} instead.
 *

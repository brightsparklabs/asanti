...
/**
 * Utility class for obtaining mocked instances of {@link AsnData} which conform to the test
...
public class MockDecodedAsnData
{
    ...
    /**
     * Return a builder for creating mocked instances of {@link AsnData}.
     *
     * By default the returned builder will include the following two tags:
     *
     * <ul>
     *
     * <li>"/null" which returns {@code null} when {@link AsnData#getBytes(String)} is
     * called</li>
     *
     * <li>"/empty" which returns an empty byte array when {@link AsnData#getBytes(String)}
     * is called</li>
     *
     * </ul>
     *
    ...
    /**
     * Builder for creating mocked instances of {@link AsnData}
     *
     * @author brightSPARK Labs
     */
    public static class Builder
    {
        ...
        final AsnData mockedInstance = mock(AsnData.class);
         ...
         *
         * @return a mocked instance of {@link AsnData}
         */
        public AsnData build()
        {

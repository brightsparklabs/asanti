...
/**
 * Utility class for obtaining mocked instances of {@link AsnSchemaTypeDefinition} which conform to
...
public class MockAsnSchemaTypeDefinition {
     ...
     * @param builtinType the underlying ASN.1 type of the defined type
     */
    ...
    */
    /**
     * Creates mock {@link AsnSchemaTypeDefinition} instances conforming to the 'Document-PDU'
     * module in the test ASN.1 schema defined in the {@code README.md} file
     *
     * @return mock instances for use within the 'Document-PDU' module
     */
    public static ImmutableList<AsnSchemaTypeDefinition>
            createMockedAsnSchemaTypeDefinitionsForDocumentPdu() {
        final ImmutableList.Builder<AsnSchemaTypeDefinition> listBuilder = ImmutableList.builder();

        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Document", MockAsnSchemaType.createMockedAsnSchemaTypeForDocumentPdu()));

        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Header", MockAsnSchemaType.getDocumentHeader()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition("Body", MockAsnSchemaType.getDocumentBody()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Footer", MockAsnSchemaType.getDocumentFooter()));

        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "PublishedMetadata", MockAsnSchemaType.getDocumentPublishedMetadata()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
        ...
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Section-Note", MockAsnSchemaType.getDocumentSectionNote()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Section-Main", MockAsnSchemaType.getDocumentSectionMain()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Paragraph", MockAsnSchemaType.getDocumentParagraph()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "References", MockAsnSchemaType.getDocumentReferences()));
        listBuilder.add(
                createMockedAsnSchemaTypeDefinition(
                        "Due-Date", MockAsnSchemaType.getDocumentDueDate()));

        return listBuilder.build();
    }

    /**
     * Creates mock {@link AsnSchemaTypeDefinition} instances conforming to the 'People-Protocol'
     * module in the test ASN.1 schema defined in the {@code README.md} file
     *
    ...
    //         * @return this builder
    //         */
    //        public MockAsnSchemaTypeDefinitionBuilder setConstraint(AsnSchemaConstraint
    // constraint)
    //        {
    ...
    //         *         tag name of the component type
    //         * @param typeName
    //         *         type name of the SEQUENCE OF component type E.g. {@code "SEQUENCE OF
    // Paragraph"}
    //         *
    //         * @return this builder
    //         */
    ...
    //         * @return this builder
    //         */
    //        public MockAsnSchemaTypeDefinitionBuilder addSetOfComponentType(String tag, String
    // tagName,
    //                String typeName)
    //        {

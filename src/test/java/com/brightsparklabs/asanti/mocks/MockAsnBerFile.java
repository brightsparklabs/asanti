...
public class MockAsnBerFile {
    ...
    public static final String EXAMPLE_SCHEMA_DOCUMENT_PDU_MINIMUM =
            new StringBuilder()
                    .append("doc Document ::=\n")
                    .append("{\n")
                    .append("  header\n")
                    ...
                    .append(
                            "          points {'506f696e7420312e31'H, '506f696e7420312e32'H, '506f696e7420312e33'H}\n")
                    .append("        },\n")
                    .append("        {\n")
                    // title: "Paragraph 2"
                    ...
                    .append(
                            "          points {'506f696e7420322e31'H, '506f696e7420322e32'H, '506f696e7420322e33'H}\n")
                    .append("        }\n")
                    .append("      }\n")
                    .append("    }\n")
                    .append("  },\n")
    ...
    public static final String EXAMPLE_SCHEMA_PEOPLE_PDU_MINIMUM =
            new StringBuilder()
                    .append("team People ::= \n")
                    .append("{  \n")
                    // firstName: "Mickey", lastName: "Mouse"
    ...
    // generated using http://asn1-playground.oss.com/
    private static final byte[] EXAMPLE_SCHEMA_PEOPLE_PDU_MINIMUM_BER =
            hexEncoding.decode(

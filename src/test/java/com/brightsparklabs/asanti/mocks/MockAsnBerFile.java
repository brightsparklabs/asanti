...
/**
 * Utility class for obtaining mocked ASN.1 BER files which conform to the test
...
public class MockAsnBerFile
{
    ...
    /**
     * bytes from encoding {@link #EXAMPLE_SCHEMA_DOCUMENT_PDU_MINIMUM} using
     * BER
     */
     ...
     * Each PDU is a copy of {@link #EXAMPLE_SCHEMA_DOCUMENT_PDU_MINIMUM}.
     *
     * @param pduCount
     ...
     */
    public static File createAsnBerFileContainingDocumentPdus(int pduCount) throws IOException
    {
        return createAsnBerFile(pduCount, EXAMPLE_SCHEMA_DOCUMENT_PDU_MINIMUM_BER);
    }

    /**
     * Creates an ASN.1 BER binary file containing the specified number of PDUs.
     * Each PDU is a copy of {@link #EXAMPLE_SCHEMA_PEOPLE_PDU_MINIMUM}.
     *
     * @param pduCount
     *            number of PDUs to include in the file
     *
     ...
     *             if any errors occur while creating the file
     */
    public static File createAsnBerFileContainingPeoplePdus(int pduCount) throws IOException
    {
    ...
    private static File createAsnBerFile(int pduCount, byte[] pdu) throws IOException
    {
        ...
        final ByteSink sink = Files.asByteSink(berFile, FileWriteMode.APPEND);

...
/**
 * Units tests for {@link TeletexStringDecoder}
 *
 * @author brightSPARK Labs
 */
public class TeletexStringDecoderTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final TeletexStringDecoder instance = TeletexStringDecoder.getInstance();

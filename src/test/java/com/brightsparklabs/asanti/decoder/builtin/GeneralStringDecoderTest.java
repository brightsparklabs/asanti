...
/**
 * Units tests for {@link GeneralStringDecoder}
 *
 * @author brightSPARK Labs
 */
public class GeneralStringDecoderTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final GeneralStringDecoder instance = GeneralStringDecoder.getInstance();

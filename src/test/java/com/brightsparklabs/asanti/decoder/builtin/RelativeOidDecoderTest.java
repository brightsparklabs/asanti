...
/**
 * Units tests for {@link RelativeOidDecoder}
 *
 * @author brightSPARK Labs
 */
public class RelativeOidDecoderTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final RelativeOidDecoder instance = RelativeOidDecoder.getInstance();

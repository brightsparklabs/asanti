...
/**
 * Units tests for {@link RelativeIriDecoder}
 *
 * @author brightSPARK Labs
 */
public class RelativeIriDecoderTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final RelativeIriDecoder instance = RelativeIriDecoder.getInstance();

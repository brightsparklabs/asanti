...
/**
 * Units tests for {@link VideotexStringDecoder}
 *
 * @author brightSPARK Labs
 */
public class VideotexStringDecoderTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final VideotexStringDecoder instance = VideotexStringDecoder.getInstance();

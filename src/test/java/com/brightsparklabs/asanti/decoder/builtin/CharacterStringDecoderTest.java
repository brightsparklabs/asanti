...
/**
 * Units tests for {@link CharacterStringDecoder}
 *
 * @author brightSPARK Labs
 */
public class CharacterStringDecoderTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final CharacterStringDecoder instance = CharacterStringDecoder.getInstance();

...
/**
 * Units tests for {@link RelativeOidIriDecoder}
 *
 * @author brightSPARK Labs
 */
public class RelativeOidIriDecoderTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final RelativeOidIriDecoder instance = RelativeOidIriDecoder.getInstance();

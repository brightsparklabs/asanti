...
/**
 * Units tests for {@link UniversalStringDecoder}
 *
 * @author brightSPARK Labs
 */
public class UniversalStringDecoderTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final UniversalStringDecoder instance = UniversalStringDecoder.getInstance();

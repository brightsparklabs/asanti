...
/**
 * Units tests for {@link EmbeddedPDVDecoder}
 *
 * @author brightSPARK Labs
 */
public class EmbeddedPDVDecoderTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final EmbeddedPDVDecoder instance = EmbeddedPDVDecoder.getInstance();

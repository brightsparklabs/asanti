...
/**
 * Units tests for {@link ObjectClassFieldDecoder}
 *
 * @author brightSPARK Labs
 */
public class ObjectClassFieldDecoderTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final ObjectClassFieldDecoder instance = ObjectClassFieldDecoder.getInstance();

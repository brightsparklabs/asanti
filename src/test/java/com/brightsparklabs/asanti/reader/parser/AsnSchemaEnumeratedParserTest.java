...
public class AsnSchemaEnumeratedParserTest {
    ...
    public void testParseEnumeratedOptions_NullOrEmpty() throws Exception {
        ...
        ImmutableList<AsnSchemaNamedTag> options =
                AsnSchemaNamedTagParser.parseEnumeratedOptions(null);
    ...
    public void testParseIntegerDistinguishedValues_NullOrEmpty() throws Exception {
        ...
        ImmutableList<AsnSchemaNamedTag> distinguishedValues =
                AsnSchemaNamedTagParser.parseIntegerDistinguishedValues(null);
     ...
     *
     * @param namedTag namedTag to test
     * @param expectedTag expected tag for the option
     * @param expectedTagName expected tag name for the option
     */
    private void testNamedTag(
            AsnSchemaNamedTag namedTag, String expectedTag, String expectedTagName) {

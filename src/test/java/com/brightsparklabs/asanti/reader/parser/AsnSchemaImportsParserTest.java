...
public class AsnSchemaImportsParserTest {
    ...
    private static final String TEST_INVALID_IMPORTS_STATEMENT = "Person FROM People-Protocol ";
    ...
    public void testParse() throws Exception {
        final ImmutableMap<String, String> expectedMap =
                ImmutableMap.<String, String>builder().put("Person", "People-Protocol").build();

        final ImmutableMap<String, String> actualMap =
                AsnSchemaImportsParser.parse(TEST_IMPORTS_STATEMENT);

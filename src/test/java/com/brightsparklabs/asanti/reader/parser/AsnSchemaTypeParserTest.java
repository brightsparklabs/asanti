...
public class AsnSchemaTypeParserTest
{
    ...
    public void testParseBitString() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.BitString, result.getPrimitiveType().getBuiltinType());
    ...
    public void testParseBoolean() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Boolean, result.getPrimitiveType().getBuiltinType());
    }
    ...
    public void testParseChoice() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Choice, result.getPrimitiveType().getBuiltinType());
    }
    ...
    public void testParseEnumerated() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Enumerated, result.getPrimitiveType().getBuiltinType());
    }
    ...
    public void testParseGeneralString() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.GeneralString, result.getPrimitiveType().getBuiltinType());
    ...
    public void testParseGeneralizedTime() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.GeneralizedTime, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseIA5String() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Ia5String, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseInteger() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Integer, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AsnSchemaTypeWithNamedTags.class));
    }
    ...
    public void testParseNumericString() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.NumericString, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseOctetString() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.OctetString, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseOid() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Oid, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParsePrintableString() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.PrintableString, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseRelativeOid() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.RelativeOid, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseSequence() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Sequence, result.getPrimitiveType().getBuiltinType());
    ...
    public void testParseSequenceOf() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.SequenceOf, result.getPrimitiveType().getBuiltinType());
    ...
    public void testParseSet() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Set, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AsnSchemaTypeConstructed.class));
    }
    ...
    public void testParseSetOf() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.SetOf, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AsnSchemaTypeCollection.class));
    ...
    public void testParseUtf8String() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Utf8String, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseVisibleString() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.VisibleString, result.getPrimitiveType().getBuiltinType());
        assertThat(result, instanceOf(AbstractAsnSchemaType.class));
    }
    ...
    public void testParseNonPrimitive() throws Exception
    {
        ...
        assertEquals(AsnBuiltinType.Null, result.getPrimitiveType().getBuiltinType());

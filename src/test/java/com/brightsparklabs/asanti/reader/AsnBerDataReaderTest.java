...
public class AsnBerDataReaderTest {
    ...
    public static final String EXAMPLE_SCHEMA_PEOPLE_PDU_LARGE_OCTET_STRING =
            new StringBuilder()
                    ...
                    .append(
                            " lastName '4669727374206e616d652069732031303030206f6374657473206c6f6e67'H }")
                    .append("}\n")
                    .toString();
    ...
    private static final byte[] EXAMPLE_SCHEMA_PEOPLE_PDU_LARGE_OCTET_STRING_BER =
            hexEncoding.decode(
                    "318204103082040c818203e8"
                            + HEXSTRING_1000_HYPHENS
    ...
    public void testReadFile_LargeOctetString() throws Exception {
        ...
        assertArrayEquals(
                hexEncoding.decode(HEXSTRING_1000_HYPHENS),
                pdu.getBytes("/0[UNIVERSAL 16]/0[1]").get());
        assertArrayEquals(
                "First name is 1000 octets long".getBytes(Charsets.UTF_8),

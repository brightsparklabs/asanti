...
/**
 * Unit tests for {@link OLDAsnSchemaTypeDefinitionConstructed}
 *
 * @author brightSPARK Labs
 */
public class OLDAsnSchemaTypeDefinitionConstructedTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
     ...
     */
    private static class TestInstance extends OLDAsnSchemaTypeDefinitionConstructed
    {
    ...
    public void testAsnSchemaConstructedTypeDefinition_Type() throws Exception
    {
        ...
        {
            if (OLDAsnSchemaTypeDefinitionConstructed.validTypes.contains(type))
            {
                try
                {
    ...
    {
        OLDAsnSchemaTypeDefinitionConstructed instance =

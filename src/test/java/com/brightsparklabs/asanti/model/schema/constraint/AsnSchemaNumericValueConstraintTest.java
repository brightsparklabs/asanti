...
public class AsnSchemaNumericValueConstraintTest {
    ...
    public void testApply() throws Exception {
        ...
        AsnSchemaConstraintTest.checkSuccess(
                instance, BigInteger.valueOf(Long.MIN_VALUE).toByteArray());
        AsnSchemaConstraintTest.checkSuccess(
                instance, BigInteger.valueOf(Long.MIN_VALUE).add(BigInteger.TEN).toByteArray());
        AsnSchemaConstraintTest.checkSuccess(
                instance,
                BigInteger.valueOf(Long.MAX_VALUE).subtract(BigInteger.TEN).toByteArray());
        AsnSchemaConstraintTest.checkSuccess(
                instance, BigInteger.valueOf(Long.MAX_VALUE).toByteArray());
        ...
        AsnSchemaConstraintTest.checkSuccess(
                instance, new BigInteger("92233720368547758070").toByteArray());
        // test valid
        AsnSchemaConstraintTest.checkSuccess(
                instance, BigInteger.valueOf(Long.MIN_VALUE).toByteArray());
        ...
        // test invalid array
        AsnSchemaConstraintTest.checkFailure(
                instance, new byte[0], "Expected a value between 5 and -5, but no value found");
    }
}

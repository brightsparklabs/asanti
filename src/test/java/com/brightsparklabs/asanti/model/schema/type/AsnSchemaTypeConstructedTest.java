...
public class AsnSchemaTypeConstructedTest {
    ...
    public void testAsnSchemaTypeConstructedConstructorPreconditions() throws Exception {
        ...
        try {
            new AsnSchemaTypeConstructed(
                    AsnPrimitiveTypes.SEQUENCE, AsnSchemaConstraint.NULL, ImmutableList.of(), null);
            fail("NullPointerException not thrown");
        } catch (final NullPointerException ex) {
        }
    ...
    public void testAutomaticTaggingAllEmpty() throws Exception {
        ...
        ImmutableList<AsnSchemaComponentType> components =
                ImmutableList.of(
                        mockedComponent("a", "", false, AsnPrimitiveTypes.INTEGER),
                        mockedComponent("b", "", false, AsnPrimitiveTypes.INTEGER));

        AsnSchemaTypeConstructed instance =
                new AsnSchemaTypeConstructed(
                        AsnPrimitiveTypes.SEQUENCE,
                        AsnSchemaConstraint.NULL,
                        components,
    ...
    public void testAutomaticTaggingNotAllEmpty() throws Exception {
        ...
        ImmutableList<AsnSchemaComponentType> components =
                ImmutableList.of(
                        mockedComponent("a", "0", false, AsnPrimitiveTypes.INTEGER),
                        mockedComponent("b", "", false, AsnPrimitiveTypes.INTEGER));
    ...
    public void testSequenceChoice() throws ParseException {
        ...
        AsnSchemaType choice =
                MockAsnSchemaType.builder(AsnPrimitiveTypes.CHOICE)
    ...
    public void testGetComponentTypesSequence() throws Exception {
        ImmutableList<AsnSchemaComponentType> components =
                ImmutableList.of(
                        mockedComponent("a", "1", false, AsnPrimitiveTypes.INTEGER),
        ...
        final Optional<AsnSchemaComponentType> resultA =
                instance.getMatchingChild("0[1]", decodingSession);
        ...
        final Optional<AsnSchemaComponentType> resultC =
                instance.getMatchingChild("1[3]", decodingSession);
        assertTrue(resultC.isPresent());
        assertEquals(components.get(2), resultC.get());

        // check that we fail if the tag does not match
        when(decodingSession.getIndex(any(AsnSchemaTag.class))).thenReturn(1);
        final Optional<AsnSchemaComponentType> resultFail =
                instance.getMatchingChild("1[4]", decodingSession);
        ...
        when(decodingSession.getIndex(any(AsnSchemaTag.class))).thenReturn(0);
        final Optional<AsnSchemaComponentType> resultB =
                instance.getMatchingChild("0[2]", decodingSession);
        ...
        final Optional<AsnSchemaComponentType> resultEmpty =
                instance.getMatchingChild("4[10]", decodingSession);
    ...
    public void testGetComponentTypesSet() throws Exception {
        ...
        DecodingSession decodingSession = mock(DecodingSession.class);
        when(decodingSession.getIndex(any(AsnSchemaTag.class)))
                .thenReturn(10); // it should not matter what the index is
        ...
        final Optional<AsnSchemaComponentType> result =
                instance.getMatchingChild("10[2]", decodingSession);
        ...
        final Optional<AsnSchemaComponentType> resultEmpty =
                instance.getMatchingChild("2[3]", decodingSession);
        assertFalse(resultEmpty.isPresent());
    }
    ...
    public void testGetComponentTypesSequenceChoice() throws Exception {
        ...
        AsnSchemaComponentType recursive =
                mockedComponent("z/n", "4", false, AsnPrimitiveTypes.INTEGER);
        when(choice.getMatchingChild(eq("2[4]"), any(DecodingSession.class)))
                .thenReturn(Optional.of(recursive));
        ...
        final Optional<AsnSchemaComponentType> result =
                instance.getMatchingChild("2[4]", decodingSession);
        assertTrue(result.isPresent());
     ...
     *
     * @param name value to return for {@link AsnSchemaComponentType#getName()}
     * @param tag value to return for {@link AsnSchemaComponentType#getTag()}
     * @param isOptional value to return for {@link AsnSchemaComponentType#isOptional()} an
     *     AsnSchemaType is mocked around this primitive type
     ...
     * @param name value to return for {@link AsnSchemaComponentType#getName()}
     * @param tag value to return for {@link AsnSchemaComponentType#getTag()}
     * @param isOptional value to return for {@link AsnSchemaComponentType#isOptional()}
     * @param type an AsnSchemaType is mocked around this primitive type
     * @return mock instance which returns the supplied values
     */
    private AsnSchemaComponentType mockedComponent(
            String name, String tag, boolean isOptional, AsnPrimitiveType type) {
     ...
     * @param tag value to return for {@link AsnSchemaComponentType#getTag()}
     * @param isOptional value to return for {@link AsnSchemaComponentType#isOptional()}
     * @param type value to return for {@link AsnSchemaComponentType#getType()}
     * @return mock instance which returns the supplied values
     */
    private AsnSchemaComponentType mockedComponent(
            String name, String tag, boolean isOptional, AsnSchemaType type) {
        return MockAsnSchemaComponentType.createMockedComponentType(name, tag, isOptional, type);
    }
}

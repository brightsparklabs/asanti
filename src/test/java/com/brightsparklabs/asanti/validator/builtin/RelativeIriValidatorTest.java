...
/**
 * Units tests for {@link RelativeIriValidator}
 *
 * @author brightSPARK Labs
 */
public class RelativeIriValidatorTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final RelativeIriValidator instance = RelativeIriValidator.getInstance();

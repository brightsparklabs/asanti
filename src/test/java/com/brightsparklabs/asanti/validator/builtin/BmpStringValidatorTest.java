...
/**
 * Units tests for {@link BmpStringValidator}
 *
 * @author brightSPARK Labs
 */
public class BmpStringValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final BmpStringValidator instance = BmpStringValidator.getInstance();

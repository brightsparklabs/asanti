...
/**
 * Units tests for {@link RelativeOidIriValidator}
 *
 * @author brightSPARK Labs
 */
public class RelativeOidIriValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final RelativeOidIriValidator instance = RelativeOidIriValidator.getInstance();

...
public class GeneralizedTimeValidatorTest
{
    ...
    public void testValidateBytes() throws Exception
    {
        ...
        ImmutableList<byte[]> rawDates = ImmutableList.<byte[]>builder()
                ...
                .add("19450508231415.1234567890987654321234567890Z".getBytes(Charsets.UTF_8))
                .add("19450508231415.1234567890987654321234567890+10".getBytes(Charsets.UTF_8))
                .add("19450508231415.1234567890987654321234567890+1030".getBytes(Charsets.UTF_8))
                .add("19450508231415.1234567890987654321234567890-1030".getBytes(Charsets.UTF_8))

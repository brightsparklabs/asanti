...
/**
 * Units tests for {@link UniversalStringValidator}
 *
 * @author brightSPARK Labs
 */
public class UniversalStringValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final UniversalStringValidator instance = UniversalStringValidator.getInstance();

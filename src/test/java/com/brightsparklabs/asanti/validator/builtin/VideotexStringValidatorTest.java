...
/**
 * Units tests for {@link VideotexStringValidator}
 *
 * @author brightSPARK Labs
 */
public class VideotexStringValidatorTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final VideotexStringValidator instance = VideotexStringValidator.getInstance();

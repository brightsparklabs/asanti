...
/**
 * Units tests for {@link GraphicStringValidator}
 *
 * @author brightSPARK Labs
 */
public class GraphicStringValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final GraphicStringValidator instance = GraphicStringValidator.getInstance();

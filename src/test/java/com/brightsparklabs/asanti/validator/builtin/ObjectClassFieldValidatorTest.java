...
/**
 * Units tests for {@link ObjectClassFieldValidator}
 *
 * @author brightSPARK Labs
 */
public class ObjectClassFieldValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final ObjectClassFieldValidator instance = ObjectClassFieldValidator.getInstance();

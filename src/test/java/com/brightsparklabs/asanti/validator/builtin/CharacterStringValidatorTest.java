...
/**
 * Units tests for {@link CharacterStringValidator}
 *
 * @author brightSPARK Labs
 */
public class CharacterStringValidatorTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final CharacterStringValidator instance = CharacterStringValidator.getInstance();

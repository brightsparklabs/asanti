...
/**
 * Units tests for {@link Iso646StringValidator}
 *
 * @author brightSPARK Labs
 */
public class Iso646StringValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final Iso646StringValidator instance = Iso646StringValidator.getInstance();

...
/**
 * Units tests for {@link TimeOfDayValidator}
 *
 * @author brightSPARK Labs
 */
public class TimeOfDayValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final TimeOfDayValidator instance = TimeOfDayValidator.getInstance();

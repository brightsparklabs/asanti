...
/**
 * Units tests for {@link EmbeddedPDVValidator}
 *
 * @author brightSPARK Labs
 */
public class EmbeddedPDVValidatorTest {
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------

    /** instance under test */
    private static final EmbeddedPDVValidator instance = EmbeddedPDVValidator.getInstance();

...
/**
 * Units tests for {@link TeletexStringValidator}
 *
 * @author brightSPARK Labs
 */
public class TeletexStringValidatorTest
{
    // -------------------------------------------------------------------------
    // FIXTURES
    // -------------------------------------------------------------------------
    ...
    /** instance under test */
    private static final TeletexStringValidator instance = TeletexStringValidator.getInstance();
